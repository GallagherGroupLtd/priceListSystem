    ...
    this.on('MassUploadItemStructure', req =>
        handleMassUpload(req, cds.entities.PricelistItemStructureComponents,
            ...
            r => ({
                ...
                MainCategoryLocal: r["Main Category Local Description"] || r["MainCategoryLocal"],
                SubCategory1Local: r["SubCategory 1 Local Description"] || r["SubCategory1Local"],
                SubCategory2Local: r["SubCategory 2 Local Description"] || r["SubCategory2Local"],
                SubCategory3Local: r["SubCategory 3 Local Description"] || r["SubCategory3Local"],
                SubCategory4Local: r["SubCategory 4 Local Description"] || r["SubCategory4Local"],
                SubCategory5Local: r["SubCategory 5 Local Description"] || r["SubCategory5Local"]
            })
        )
    );
