...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "pricelistapp/myrequest/myrequest/test/integration/FirstJourney",
    "pricelistapp/myrequest/myrequest/test/integration/MyRequestListJourney",
    "pricelistapp/myrequest/myrequest/test/integration/MyRequestObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
