...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "pricelistapp/applicationlog/test/integration/FirstJourney",
    "pricelistapp/applicationlog/test/integration/ApplicationLogListJourney",
    "pricelistapp/applicationlog/test/integration/ApplicationLogObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
