sap.ui.define([
    ...
    return Controller.extend("pricelistapp.pricelistdisplay.ext.controller.ProductsTree", {
        onInit: function () {
        ...
        onSelectionChangeV2: function (oEvent) {
            ...
            const sFePrefix = "pricelistapp.pricelistdisplay::PricelistDataObjectPage--fe::CustomSubSection::PricelistMainCategory--";
            ...
            if (iIndex >= 0) {
                ...
                if (oSelectedNode) {
                    ...
                    const sSubSectionId = "pricelistapp.pricelistdisplay::PricelistDataObjectPage--fe::CustomSubSection::PricelistMainCategory";
